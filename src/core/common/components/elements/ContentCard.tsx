...
Card.Header = function CardHeader({ variant, children, className }: CardHeaderProps) {
  const Icon = variantStyles[variant].icon

  return (
    <div className={cn('relative rounded-t-lg duration-500 h-[200px] overflow-hidden', className)}>
      <div
        className={cn(
...
Card.Title = function CardTitle({ variant, children, className }: CardTitleProps) {
  return (
    <h3
      className={cn(
...
Card.Label = function CardLabel({ variant, children, className }: CardLabelProps) {
  return (
    <div
      className={cn(
...
Card.Tags = function CardTags({ variant, tags, label = 'TOPICS', className }: CardTagsProps) {
