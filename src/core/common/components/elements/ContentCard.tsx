...
Card.Label = function CardLabel({ variant, children, className }: CardLabelProps) {
  return (
    <div
      className={cn(
        'inline-flex items-center px-2.5 py-0.5 text-[10px] rounded-sm text-white font-medium mb-2',
...
Card.Tags = function CardTags({ variant, tags, label, className }: CardTagsProps) {
  return (
