...
export const EnhancedIntroductionBlock: React.FC<
...
> = ({ heading, subheading, content }) => {
	...
	return (
		<section className='relative overflow-hidden rounded-xl p-8 border border-neutral-800/10 dark:border-white/10'>
			...
			{/* Accent elements */}
			<div className='absolute -right-20 top-40 h-40 w-40 rounded-full bg-purple-500/20 blur-3xl filter' />
			<div className='absolute left-40 -bottom-20 h-40 w-40 rounded-full bg-indigo-500/20 blur-3xl filter' />

			{/* Decorative elements */}
			<div className='absolute top-0 right-0 h-20 w-20 overflow-hidden'>
				<div className='absolute -right-10 -top-10 h-20 w-20 rotate-45 border-b-2 border-r-2 border-teal-500/30' />
			</div>
			<div className='absolute bottom-0 left-0 h-20 w-20 overflow-hidden'>
				<div className='absolute -left-10 -bottom-10 h-20 w-20 rotate-45 border-t-2 border-l-2 border-indigo-500/30' />
			</div>
			...
			<div className='relative z-10'>
				...
				<div className='mb-4'>
					<h1 className='font-sora text-4xl font-bold md:text-5xl lg:text-6xl'>
						...
						<span className='ml-2 animate-waving-hand text-3xl md:text-4xl'>
							👋
						</span>
					</h1>
				...
				<div className='mb-8 flex flex-wrap gap-2'>
					{['TypeScript', 'React', 'Node.js', 'Next.js', 'GraphQL'].map(
						(tech, index) => (
							<span
								key={tech}
				...
				<div className='relative mb-8 rounded-lg border border-neutral-200/50 bg-white/30 p-6 backdrop-blur-sm dark:border-neutral-800/50 dark:bg-black/30'>
					<div className='absolute -right-1 -top-1 h-3 w-3 border-r-2 border-t-2 border-teal-500' />
					<div className='absolute -left-1 -bottom-1 h-3 w-3 border-l-2 border-b-2 border-indigo-500' />
