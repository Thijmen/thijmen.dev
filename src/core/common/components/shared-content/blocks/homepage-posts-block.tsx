      ...
      <div className="grid pt-4 grid-cols-1 sm:grid-cols-2 gap-8">
        {thePosts.map((post) => (
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className="group relative flex flex-col h-[400px] overflow-hidden rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-md hover:shadow-xl hover:shadow-indigo-500/20 transition-all duration-300">
              ...
              <div className="flex flex-col justify-between flex-grow p-5 bg-gradient-to-b from-neutral-50 to-neutral-100 dark:from-neutral-900 dark:to-neutral-950">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-neutral-200 dark:border-neutral-800">
                  ...
                  <Link href={`/posts/${post.slug}`} className="inline-flex items-center text-xs tracking-wide text-indigo-600 dark:text-indigo-400 font-medium group/link">
                    Read article here
                    <svg
